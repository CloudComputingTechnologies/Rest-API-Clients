...
namespace IO.Swagger.Client
{
    ...
    public class ApiClient
    {
        ...
        /// with default configuration and base path (http://localhost:15534).
        /// </summary>
        public ApiClient()
        {
            Configuration = Configuration.Default;
            RestClient = new RestClient("http://localhost:15534");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (http://localhost:15534).
        /// </summary>
        ...
        public ApiClient(String basePath = "http://localhost:15534")
        {
